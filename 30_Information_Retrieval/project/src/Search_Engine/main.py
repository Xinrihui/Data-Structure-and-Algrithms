...
from Search_Engine.Lib.search_engine import SearchEngine
...
def search():
    try:
        ...
        if keys not in ['']:
            ...
            return render_template('search.html', checked=checked, key=keys, docs=docs, page=page, error=True) #TODO: 为什么一定要 return  render_template('high_search.html')
